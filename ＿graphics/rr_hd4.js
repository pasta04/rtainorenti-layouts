...
/***/ "./src/browser/graphics/views/rr_hd4.tsx":
/*!***********************************************!*\
  !*** ./src/browser/graphics/views/rr_hd4.tsx ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const App = () => {
  ...
  react__WEBPACK_IMPORTED_MODULE_1__.useEffect(() => {
    ...
    image.addEventListener('load', function () {
      ...
      ctx.fillRect(750, 20 + gameH, gameW, gameH); // 走者タイマー
      // 1P

      ctx.fillRect(10 + gameW, 10, timerW, timerH); // 2P

      ctx.fillRect(SCREEN_WIDTH - (gameW + 10 + timerW), 10 + gameH - timerH, timerW, timerH); // 3P

      ctx.fillRect(10 + gameW, 20 + gameH, timerW, timerH);
      ctx.fillRect(SCREEN_WIDTH - (gameW + 10 + timerW), (10 + gameH) * 2 - timerH, timerW, timerH);
    });
  });
  ...
  return react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", {
    ...
    style: {
      fontSize: (0,_util__WEBPACK_IMPORTED_MODULE_5__.calcWidthFitFontSize)((runners === null || runners === void 0 ? void 0 : (_runners$runners$ = runners.runners[0]) === null || _runners$runners$ === void 0 ? void 0 : _runners$runners$.name) ?? '', 200, RUNNER_FONT_MIN, RUNNER_FONT_MAX, 'px', 'PixelMplus10')
    }
    ...
    style: {
      fontSize: (0,_util__WEBPACK_IMPORTED_MODULE_5__.calcWidthFitFontSize)((runners === null || runners === void 0 ? void 0 : (_runners$runners$3 = runners.runners[1]) === null || _runners$runners$3 === void 0 ? void 0 : _runners$runners$3.name) ?? '', 200, RUNNER_FONT_MIN, RUNNER_FONT_MAX, 'px', 'PixelMplus10')
    }
    ...
    className: classes.runInfoValue1p,
    style: {
      fontSize: (0,_util__WEBPACK_IMPORTED_MODULE_5__.calcWidthFitFontSize)((runners === null || runners === void 0 ? void 0 : (_runners$runners$5 = runners.runners[2]) === null || _runners$runners$5 === void 0 ? void 0 : _runners$runners$5.name) ?? '', 200, RUNNER_FONT_MIN, RUNNER_FONT_MAX, 'px', 'PixelMplus10')
    }
    ...
    className: classes.runInfoValue2p,
    style: {
      fontSize: (0,_util__WEBPACK_IMPORTED_MODULE_5__.calcWidthFitFontSize)((runners === null || runners === void 0 ? void 0 : (_runners$runners$7 = runners.runners[3]) === null || _runners$runners$7 === void 0 ? void 0 : _runners$runners$7.name) ?? '', 200, RUNNER_FONT_MIN, RUNNER_FONT_MAX, 'px', 'PixelMplus10')
    }
    ...
    style: {
      fontSize: (0,_util__WEBPACK_IMPORTED_MODULE_5__.calcWidthFitFontSize)((runners === null || runners === void 0 ? void 0 : runners.title) ?? '', 380, 12, 22, 'px', 'PixelMplus10')
    }
    ...
    className: classes.gameValue,
    style: {
      fontSize: (0,_util__WEBPACK_IMPORTED_MODULE_5__.calcWidthFitFontSize)((runners === null || runners === void 0 ? void 0 : runners.category) ?? '', 380, 12, 22, 'px', 'PixelMplus10')
    }
    ...
    style: {
      fontSize: (0,_util__WEBPACK_IMPORTED_MODULE_5__.calcWidthFitFontSize)(commentators ?? '', 530, 14, 18, 'px', 'PixelMplus10')
    }
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["common-node_modules_material-ui_core_esm_styles_makeStyles_js-node_modules_use-it_interval_di-7046fc","vendors-node_modules_moment_locale_af_js-node_modules_moment_locale_ar-dz_js-node_modules_mom-248d90"], () => (__webpack_require__("./src/browser/graphics/views/rr_hd4.tsx")))
/******/ 	__webpack_exports__ = __webpack_require__.O(__webpack_exports__);
/******/ 	
/******/ })()
;
//# sourceMappingURL=rr_hd4.js.map