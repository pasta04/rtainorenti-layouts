...
/***/ "./src/browser/graphics/views/rr_sd3.tsx":
/*!***********************************************!*\
  !*** ./src/browser/graphics/views/rr_sd3.tsx ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const App = () => {
  var _runners$runners$, _runners$runners$2, _runners$runners$3, _runners$runners$4, _runners$runners$5, _runners$runners$6;
  ...
  const [commentatorFontSize, setCommentatorFontSize] = react__WEBPACK_IMPORTED_MODULE_1__.useState(22);

  const runnerHandler = newVal => {
    setRunners(newVal && { ...newVal
    }); // 解説のフォントサイズを計算

    let temp = 22;
    newVal === null || newVal === void 0 ? void 0 : newVal.commentators.map(commentator => {
      const size = (0,_util__WEBPACK_IMPORTED_MODULE_5__.calcWidthFitFontSize)(commentator.name, 260, 12, 22, 'px', 'PixelMplus10');
  ...
  return react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", {
    ...
    style: {
      fontSize: (0,_util__WEBPACK_IMPORTED_MODULE_5__.calcWidthFitFontSize)((runners === null || runners === void 0 ? void 0 : (_runners$runners$ = runners.runners[0]) === null || _runners$runners$ === void 0 ? void 0 : _runners$runners$.name) ?? '', 320, 12, 35, 'px', 'PixelMplus10')
    }
    ...
    style: {
      fontSize: (0,_util__WEBPACK_IMPORTED_MODULE_5__.calcWidthFitFontSize)((runners === null || runners === void 0 ? void 0 : (_runners$runners$3 = runners.runners[1]) === null || _runners$runners$3 === void 0 ? void 0 : _runners$runners$3.name) ?? '', 320, 12, 35, 'px', 'PixelMplus10')
    }
    ...
    className: classes.runInfoValue1p,
    style: {
      fontSize: (0,_util__WEBPACK_IMPORTED_MODULE_5__.calcWidthFitFontSize)((runners === null || runners === void 0 ? void 0 : (_runners$runners$5 = runners.runners[2]) === null || _runners$runners$5 === void 0 ? void 0 : _runners$runners$5.name) ?? '', 320, 12, 35, 'px', 'PixelMplus10')
    }
    ...
    style: {
      fontSize: (0,_util__WEBPACK_IMPORTED_MODULE_5__.calcWidthFitFontSize)((runners === null || runners === void 0 ? void 0 : runners.title) ?? '', 350, 12, 22, 'px', 'PixelMplus10')
    }
    ...
    className: classes.gameValue,
    style: {
      fontSize: (0,_util__WEBPACK_IMPORTED_MODULE_5__.calcWidthFitFontSize)((runners === null || runners === void 0 ? void 0 : runners.category) ?? '', 350, 12, 22, 'px', 'PixelMplus10')
    }
  ...
  }, runners === null || runners === void 0 ? void 0 : runners.commentators.map(commentator => {
    return react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", {
      style: {
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["common-node_modules_material-ui_core_esm_styles_makeStyles_js-node_modules_use-it_interval_di-7046fc","vendors-node_modules_moment_locale_af_js-node_modules_moment_locale_ar-dz_js-node_modules_mom-248d90"], () => (__webpack_require__("./src/browser/graphics/views/rr_sd3.tsx")))
/******/ 	__webpack_exports__ = __webpack_require__.O(__webpack_exports__);
/******/ 	
/******/ })()
;
//# sourceMappingURL=rr_sd3.js.map