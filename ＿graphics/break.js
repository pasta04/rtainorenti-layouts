...
/***/ "./src/browser/graphics/views/break.tsx":
/*!**********************************************!*\
  !*** ./src/browser/graphics/views/break.tsx ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const Break = () => {
  ...
  react__WEBPACK_IMPORTED_MODULE_1__.useEffect(() => {
    ...
    ctx.fillRect(0, 0, 1920, 1080); // 映像の領域を切り取り

    ctx.globalCompositeOperation = 'xor';
    const cameraW = 640;
    const cameraH = 360; // カメラ
  ...
  }, "NEXT GAME"), react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", {
    className: classes.item
  }, currentRun === null || currentRun === void 0 ? void 0 : currentRun.title), react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", {
    className: classes.item
  }, "@", currentRun === null || currentRun === void 0 ? void 0 : (_currentRun$runners = currentRun.runners) === null || _currentRun$runners === void 0 ? void 0 : _currentRun$runners.map(runner => runner.name).join(' / @'))), react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", {
