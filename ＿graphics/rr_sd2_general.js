...
/***/ "./src/browser/graphics/views/rr_sd2_general.tsx":
/*!*******************************************************!*\
  !*** ./src/browser/graphics/views/rr_sd2_general.tsx ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const App = () => {
  ...
  react__WEBPACK_IMPORTED_MODULE_1__.useEffect(() => {
    ...
    image.addEventListener('load', function () {
      ...
      const gameW = 620;
      const gameH = 465; // ゲーム1

      ctx.fillRect(10, 90, gameW, gameH); // ゲーム2

      ctx.fillRect(10 * 2 + 10 + gameW, 90, gameW, gameH);
      const timerW = 200;
      const timerH = 40; // 走者1タイマー

      ctx.fillRect(10, 90 + gameH, timerW, timerH); // 走者2タイマー
  ...
  return react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", {
    ...
    style: {
      fontSize: (0,_util__WEBPACK_IMPORTED_MODULE_5__.calcWidthFitFontSize)(commentators ?? '', 400, 12, 22, 'px', 'PixelMplus10')
    }
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["common-node_modules_material-ui_core_esm_styles_makeStyles_js-node_modules_use-it_interval_di-7046fc","vendors-node_modules_moment_locale_af_js-node_modules_moment_locale_ar-dz_js-node_modules_mom-248d90"], () => (__webpack_require__("./src/browser/graphics/views/rr_sd2_general.tsx")))
/******/ 	__webpack_exports__ = __webpack_require__.O(__webpack_exports__);
/******/ 	
/******/ })()
;
//# sourceMappingURL=rr_sd2_general.js.map